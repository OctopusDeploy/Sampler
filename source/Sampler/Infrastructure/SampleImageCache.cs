...
namespace Octopus.Sampler.Infrastructure
{
    public class SampleImageCache
    {
        ...
        private static readonly LightweightCache<string, string> ImageFileCache = new LightweightCache<string, string>();
        ...
        {
            return ImageFileCache.GetOrAdd(downloadUrl, url =>
            {
        ...
        private static string GetSHA1HashString(string downloadUrl)
        {
            ...
            {
                return sha1.ComputeHash(Encoding.UTF8.GetBytes(downloadUrl))
